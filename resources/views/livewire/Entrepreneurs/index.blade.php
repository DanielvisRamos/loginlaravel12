                ...
                @foreach ($this->users() as $user)
                    <tr class="border-b border-gray-300 ">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                                ...
                                <flux:badge variant="pill" icon="user">{{ $user->role->name ?? __('Sin rol') }}</flux:badge>
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <flux:modal.trigger name="edit-profile{{ $user->name }}">
                                ...
                                <flux:button icon='trash' wire:click='deleteUser({{ $user->id }})'>Eliminar</flux:button>
                        </td>
                    </tr>
                    <flux:modal name="edit-profile{{ $user->name }}" class="md:w-96">
                        <div class="space-y-6">
                            ...
                            <flux:text class="mt-2">Estado: <flux:badge variant="pill" color='lime'>{{$user->estado}}</flux:badge></flux:text>
